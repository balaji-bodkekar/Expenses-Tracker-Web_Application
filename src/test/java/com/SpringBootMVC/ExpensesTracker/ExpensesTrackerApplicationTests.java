 ...
 * 
 * These tests verify application context loads successfully with H2 database.
 * All tests use the default application.properties (H2) configuration.
 * 
 * Tag: 'unit' - Run with: mvn test -Dgroups="unit"
 */
@SpringBootTest
@Tag("unit")
