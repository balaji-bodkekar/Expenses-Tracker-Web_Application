 ...
 * 
 * Provides a shared MySQL container for integration tests.
 * Use @ContextConfiguration(classes = IntegrationTestConfig.class) in test classes.
 * 
 * Or inherit from this class in your test and use @TestcontainersTest.
 */
@Testcontainers
